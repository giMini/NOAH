...
echo '		
        <li class="active">Persistence</li>
      </ol>
    </section>
            ...
            <div class="box-body">
              <div class="table-responsive">			  
                <table class="table no-margin">
                  ...
                  <tbody id="suspiciouspersistenceph">
				  <div class="input-group input-group-sm">
					<form id="formpersistence" method="post" autocomplete="off">
					<input type="text" class="form-control" id="persistenceinput">
                    <span class="input-group-btn">
                      <button type="button" class="btn btn-info btn-flat" id="persistence">Go!</button>
                    </span>
					</form>
					</div>	';			
				  include_once("autorunsfetch.php");
...
$("#suspiciouspersistenceph").on( "click", ".pagination2 a", function (e){
        e.preventDefault();
	...
	echo '$("#suspiciouspersistenceph").load("autorunsfetch.php",{"page":page'.$varHunt.''.$varServer.'}, function(){';
