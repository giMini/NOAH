            ...
            <div class="box-body">
              <div class="table-responsive">
                <table class="table no-margin">
                  ...
                  <tbody id="suspiciousdnscacheph">
				  <div class="input-group input-group-sm">
					<form id="formdnscache" method="post" autocomplete="off">					
					<input type="text" class="form-control" id="dnscacheinput">
                    <span class="input-group-btn">
                      <button type="button" class="btn btn-info btn-flat" id="dnscache">Go!</button>
                    </span>
					</form>
					</div>';
				  
					include_once("dnscachefetch.php");
...
$("#suspiciousdnscacheph").on( "click", ".pagination2 a", function (e){
        e.preventDefault();
	...
	echo '$("#suspiciousdnscacheph").load("dnscachefetch.php",{"page":page'.$varHunt.''.$varServer.'}, function(){';
